...
/** Max raw characters for type="number" fields (maxlength is unreliable on number inputs). */
export const NUMERIC_INPUT_MAX_CHARS = 6;

/** Max characters for comma-formatted currency text fields (principal). */
export const FORMATTED_NUMERIC_INPUT_MAX_CHARS = 10;

/**
 * Trim overlong values on number inputs. HTML maxlength is not applied reliably for type="number".
